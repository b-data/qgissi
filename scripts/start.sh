...
cmake \
  ...
  -DWITH_EPT="$WITH_EPT" \
  -DWITH_EXIV2="$WITH_EXIV2" \
  -DWITH_GEOGRAPHICLIB="$WITH_GEOGRAPHICLIB" \
  ...
  -DWITH_INTERNAL_MESHOPTIMIZER="$WITH_INTERNAL_MESHOPTIMIZER" \
  -DWITH_INTERNAL_NLOHMANN_JSON="$WITH_INTERNAL_NLOHMANN_JSON" \
  -DWITH_INTERNAL_O2="$WITH_INTERNAL_O2" \
  -DWITH_INTERNAL_POLY2TRI="$WITH_INTERNAL_POLY2TRI" \
  -DWITH_INTERNAL_QWT="$WITH_INTERNAL_QWT" \
  ...
  -DWITH_QTPOSITIONING="$WITH_QTPOSITIONING" \
